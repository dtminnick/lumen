...
It relies on class `DataLoader` for frequency inference, seasonal period, LOESS span, 
and cleaned, validated time series.
"""
...
class ForecastEngine:
    ...
    **loader : DataLoader**
    ...
    def __init__(self, loader):
        ...
        performed until method `fit` is called.
    ...
    def fit(self):
        ...
        This method extracts the primary value series from the loader, fits 
        the multiplicative STL decomposition, and stores the fitted values for convenience

        Notes
        -----
        After calling method `fit`, the following attributes become available:

        * `fitted_`, fitted values,
        * `trend`, trend component,
        * `seasonal_factors`, seasonal cycle,
        * `seasonal_factors_`, seasonal factors over time, and
    ...
    def forecast(self, steps: int):
        ...
        This method builds a future datetime index using the loader's 
        canonical frequency, calls method `SeriesDecomposition.predict` 
        to generate forecast values, and Stores the forecast and future 
    ...
    def trend(self):
        ...
        """
        Returns the trend component from the decomposition.
        """
    ...
    def seasonal_factors(self):
        ...
        """
        Returns the seasonal cycle (one full seasonal period).
        """
    ...
    def seasonal_factors_(self):
        ...
        """
        Returns seasonal factors expanded across the full timeline.
        """
    ...
    def fitted(self):
        ...
        """
        Returns fitted values from the decomposition.
        """
    ...
    def residuals(self):
        ...
        """
        Returns residuals from the decomposition.
        """
